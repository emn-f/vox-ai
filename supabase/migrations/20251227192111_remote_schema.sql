...
CREATE TABLE IF NOT EXISTS "public"."chat_logs_kb" (
    "chat_log_kb_id" bigint NOT NULL,
...
ALTER TABLE "public"."chat_logs_kb" OWNER TO "postgres";


ALTER TABLE "public"."chat_logs_kb" ALTER COLUMN "chat_log_kb_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."chat_log_kb_chat_log_kb_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."chat_logs" ALTER COLUMN "chat_id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE SEQUENCE IF NOT EXISTS "public"."kb_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."kb_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."user_reports" ALTER COLUMN "id" ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE ONLY "public"."chat_logs_kb"
    ADD CONSTRAINT "chat_log_kb_chat_log_kb_id_key" UNIQUE ("chat_log_kb_id");



ALTER TABLE ONLY "public"."chat_logs_kb"
    ADD CONSTRAINT "chat_log_kb_pkey" PRIMARY KEY ("chat_log_kb_id");



ALTER TABLE ONLY "public"."chat_logs"
    ADD CONSTRAINT "chat_logs_pkey" PRIMARY KEY ("chat_id");
...
ALTER TABLE ONLY "public"."chat_logs_kb"
    ADD CONSTRAINT "chat_log_kb_kb_id_fkey" FOREIGN KEY ("kb_id") REFERENCES "public"."knowledge_base"("kb_id") ON UPDATE CASCADE;



ALTER TABLE ONLY "public"."chat_logs"
    ADD CONSTRAINT "chat_logs_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("session_id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."error_logs"
    ADD CONSTRAINT "error_logs_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("session_id") ON DELETE RESTRICT;
...
GRANT ALL ON FUNCTION "public"."match_knowledge_base"("query_embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "filter_topic" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."match_knowledge_base"("query_embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "filter_topic" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_knowledge_base"("query_embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "filter_topic" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."chat_logs_kb" TO "anon";
GRANT ALL ON TABLE "public"."chat_logs_kb" TO "authenticated";
GRANT ALL ON TABLE "public"."chat_logs_kb" TO "service_role";



GRANT ALL ON SEQUENCE "public"."chat_log_kb_chat_log_kb_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."chat_log_kb_chat_log_kb_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."chat_log_kb_chat_log_kb_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."kb_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."kb_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."kb_id_seq" TO "service_role";
