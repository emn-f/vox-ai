...
Fontes dos ícones utilizados na interface (Icons8 - Biblioteca Fluency e Color).

* **Linktree (Color):** `https://img.icons8.com/color/48/linktree.png`
* **Hugging Face (Color):** `https://img.icons8.com/color/48/hugging-face.png`
* **Instagram (Fluency):** `https://img.icons8.com/fluency/48/instagram-new.png`
